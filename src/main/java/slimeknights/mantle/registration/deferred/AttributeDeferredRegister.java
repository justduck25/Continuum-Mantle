...
public class AttributeDeferredRegister extends DeferredRegisterWrapper<Attribute> {
   ...
   */
  public DeferredHolder register(String name, double defaultValue, double min, double max, boolean syncable) {
   ...
   * @return  Registered attribute
   */
  public DeferredHolder registerPercent(String name, double defaultValue, boolean syncable) {
   ...
   * @return  Registered attribute
   */
  public DeferredHolder registerMultiplier(String name, boolean syncable) {
