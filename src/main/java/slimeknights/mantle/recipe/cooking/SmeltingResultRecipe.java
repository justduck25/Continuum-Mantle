...
@Getter
public class SmeltingResultRecipe extends AbstractResultCookingRecipe {
  ...
  public SmeltingResultRecipe(Identifier id, String group, CookingBookCategory category, Ingredient ingredient, ItemOutput result, float experience, int cookingTime) {
